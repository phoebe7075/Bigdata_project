...
loss_eq=pd.read_csv(r'Ukraine_Russia_War\archive\russia_losses_equipment.csv')

print(loss_eq.tail())

eq_cost = [21.43, 12.8, 0.5, 0.039, 2, 2.3, 0.06, 600, 115, 20]
loss_eq.drop(['fuel tank', 'vehicles and fuel tanks', 'drone', 'special equipment', 'greatest losses direction', 'cruise missiles'], axis=1, inplace=True) #계산불가능 값 제외
